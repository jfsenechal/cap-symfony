...
class EventRepository extends ServiceEntityRepository
{
    ...
    public function findByCommercant(CommercioCommercant $commercant): array
    {
        return $this->createQb()
            ->andWhere('event.commercioCommercant = :shop')
    ...
    {
        return $this->createQueryBuilder('event')
            ->leftJoin('event.commercioCommercant', 'commercioCommercant', 'WITH')
            ->leftJoin('event.commercioAdministrator', 'commercioAdministrator', 'WITH')
            ->addSelect('commercioCommercant', 'commercioAdministrator');
    }
